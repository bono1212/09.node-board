...
// SELECT * FROM users WHERE userid='bono';
// SELECT * FROM users WHERE userid LIKE '%bo%';
// SELECT * FROM users WHERE userid='bono' AND id=3; <- 미구현
// SELECT * FROM users WHERE userid='bono' or id=3; <- 미구현
// where: {['userid', 'bono']};
// where: ['userid', 'bono', 'LIKE'];
// where: {op:'AND', fields: [['userid', 'bono', 'LIKE'], ['userpq', '000000']]};
// where: {op:'OR', fields: [['userid', 'bono'], ['userpq', '000000']]};
